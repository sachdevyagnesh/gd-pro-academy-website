...
const serviceOptions = [
  ...
  },
  {
    ...
    description: "Accelerate your career with practical skills in sales, communication, and professional development. Enroll anytime or get personalized coaching.",
    features: [
