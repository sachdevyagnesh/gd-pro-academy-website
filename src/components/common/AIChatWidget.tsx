...
export function AIChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm the GD Pro Academy assistant. How can I help you today? Ask me about our training programs, services, or anything else!",
    },
  ]);
  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-24 right-6 z-50 w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center transition-all hover:scale-110",
