  ...
  "rounded-xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 bg-transparent shadow-none hover:bg-card/50",
        gold: "border-secondary/30 shadow-gold hover:shadow-elevated",
        program: "shadow-card hover:shadow-elevated hover:-translate-y-1",
      },
    },
    defaultVariants: {
      variant: "default",
